export const summary = `<p>Well, I made it almost a month since the last design change. However, this redesign is a little more extensive. </p>`;
...
export const meta = {
  ...
  description: `Well, I made it almost a month since the last design change. However, this redesign is a little more extensive.`,
};
