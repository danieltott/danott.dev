...
Next.js recently released their new App Router, which introduces an entirely new paradigm for creating Next.js apps. As part of [Virtual Coffee's Lunch & Learn series](https://www.youtube.com/playlist?list=PLh9uT23TA65idCyc_orC85RefgY_-fKsG), I gave a two-part presentation where we dove in to how the App Router works.
