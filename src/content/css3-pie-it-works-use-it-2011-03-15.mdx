export const summary = `<p>We all have various tools in our box to deal with the constant headache that is Internet Explorer. Browser hacks, conditional comments, filters, pounding our heads against the wall, etc (wait, is it possible that's where the headaches come from? I'll look into it and get back to you). </p>
...
export const meta = {
  ...
  description: `We all have various tools in our box to deal with the constant headache that is Internet Explorer.`,
};
