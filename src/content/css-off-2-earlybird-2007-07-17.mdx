...
export const meta = {
  ...
  description: `Judging is underway  for the latest CSSOFF contest, so, as promised, here's my thoughts on this entry.`,
};

[Judging is underway](http://cssoff.com/2007/07/16/earlybird-judging-is-underway/trackback/) for the latest CSSOFF contest, so, as promised, here's [my entry](http://danott.dev/cssoff/earlybird/ 'my earlybird entry') , and here's the [jpeg of the initial file](http://danott.dev/thoughts/wp-content/uploads/earlybird.jpg 'Initial Earlybird File') we got. As I said before, I'm pretty happy with the results. Here are my thoughts on this entry.
