...
import moocards from './images/moocards.jpg';

export const summary = `<p>Back from the trip. It was wonderful. Some catch-up news:</p>`;
...
export const meta = {
  ...
  description: `Back from the trip. It was wonderful. Here's some catch-up news.`,
};
...
<ClientImage src={moocards} alt="Moo.com MiniCards" />
