...
export const meta = {
  ...
  description: `I have a lot of articles "in the pipes," but I've been finding it hard to get into the rhythm of writing again, so I thought I'd start with an easy post to get the juices flowing.`,
};
