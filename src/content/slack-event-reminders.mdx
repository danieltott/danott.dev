...
export const meta = {
  ...
  description: 'Post event reminders to Slack using Netlify Functions',
};
...
<ClientImage src={slackEventReminders} alt="Slack event reminders screenshot" />
