          ...
          <ToolsSection title="This site">
            ...
            <li className="flex items-center gap-2 group">
              ...
              {/* <svg
                ...
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                className="w-6 h-6 stroke-stone-800 fill-green-metal-300 group-hover:animate-bounce"
              >
                <path
                  strokeLinecap="round"
              ...
              <div>
                Read more about how I built this site in my{` `}
                <Link
                  className="text-link"
                  href="/thoughts/new-site-danott-dev"
                >
                  blog post
                </Link>
                !
